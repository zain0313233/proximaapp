...
import { Bell, User, Globe, Shield, Moon, Sun, Save } from 'lucide-react'
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button 
          ...
          className={`relative inline-flex h-6 w-11 items-center rounded-full ${settings.general.darkMode ? 'bg-blue-600' : 'bg-gray-200'}`}
        >
      ...
      <div className="flex items-center justify-between">
        ...
        <button 
          ...
          className={`relative inline-flex h-6 w-11 items-center rounded-full ${settings.general.compactView ? 'bg-blue-600' : 'bg-gray-200'}`}
        >
      ...
      <div className="flex items-center justify-between">
        ...
        <button 
          ...
          className={`relative inline-flex h-6 w-11 items-center rounded-full ${settings.general.autoSave ? 'bg-blue-600' : 'bg-gray-200'}`}
        >
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button 
          ...
          className={`relative inline-flex h-6 w-11 items-center rounded-full ${settings.notifications.emailAlerts ? 'bg-blue-600' : 'bg-gray-200'}`}
        >
      ...
      <div className="flex items-center justify-between">
        ...
        <button 
          ...
          className={`relative inline-flex h-6 w-11 items-center rounded-full ${settings.notifications.taskReminders ? 'bg-blue-600' : 'bg-gray-200'}`}
        >
      ...
      <div className="flex items-center justify-between">
        ...
        <button 
          ...
          className={`relative inline-flex h-6 w-11 items-center rounded-full ${settings.notifications.weeklyDigest ? 'bg-blue-600' : 'bg-gray-200'}`}
        >
      ...
      <div className="flex items-center justify-between">
        ...
        <button 
          ...
          className={`relative inline-flex h-6 w-11 items-center rounded-full ${settings.notifications.mentionAlerts ? 'bg-blue-600' : 'bg-gray-200'}`}
        >
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button 
          ...
          className={`relative inline-flex h-6 w-11 items-center rounded-full ${settings.privacy.shareTaskData ? 'bg-blue-600' : 'bg-gray-200'}`}
        >
      ...
      <div className="flex items-center justify-between">
        ...
        <button 
          ...
          className={`relative inline-flex h-6 w-11 items-center rounded-full ${settings.privacy.activityTracking ? 'bg-blue-600' : 'bg-gray-200'}`}
        >
      ...
      <div className="flex items-center justify-between">
        ...
        <button 
          ...
          className={`relative inline-flex h-6 w-11 items-center rounded-full ${settings.privacy.saveHistory ? 'bg-blue-600' : 'bg-gray-200'}`}
        >
